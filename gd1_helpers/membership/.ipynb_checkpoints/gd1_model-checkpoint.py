    ...
    variables = {
        ...
        "pm1": Normal1DSplineMixtureVariable(
            param_priors={
                ...
                "mean1": dist.Uniform(-7, 20).expand((pm1_knots.size,)),
                "mean2": dist.Uniform(-7, 20).expand((pm1_knots.size,)),
                "ln_std1": dist.Uniform(-3, 4).expand((pm1_knots.size,)),
                "ln_std2": dist.Uniform(-3, 4).expand((pm1_knots.size,)),
            },
            knots=pm1_knots,
            spline_ks={"w": 1},
        ...
        "pm2": Normal1DSplineMixtureVariable(
            param_priors={
                ...
                "ln_std1": dist.Uniform(-3, 2).expand((pm2_knots.size,)),
                "ln_std2": dist.Uniform(-3, 2).expand((pm2_knots.size,)),
            },
            knots=pm2_knots,
            spline_ks={"w": 1},
